...
const ResumePreview = ({ formData, selectedTemplate, scale = 1 }) => {
  ...
  return (
    <div className="flex-1 relative bg-gray-100 overflow-hidden">
      {/* Preview Controls */}
      <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 flex items-center gap-2 bg-white rounded-lg shadow-lg p-2 z-10">
      ...
      <div className="w-full h-full overflow-auto p-8 flex items-center justify-center">
        ...
        >
          ...
          <div className="w-full h-full p-12 overflow-hidden">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Debitis optio possimus voluptatum nulla aspernatur deserunt reprehenderit nemo excepturi esse sunt hic dolore natus magni quibusdam eos, id eius minus porro!
