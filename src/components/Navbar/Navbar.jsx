...
const Navbar = () => {
  ...
  return (
    <nav className={`bg-gray-800 text-white flex items-center justify-between px-4 py-4 transition-all duration-300 ${isScrolled ? 'fixed top-0 left-0 w-full z-50' : ''}`}>
